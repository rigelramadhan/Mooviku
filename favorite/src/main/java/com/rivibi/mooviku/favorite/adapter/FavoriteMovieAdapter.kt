package com.rivibi.mooviku.favorite.adapter
...
class FavoriteMovieAdapter(private val list: List<Movie>, private val onClick: (Int) -> Unit) :
    Adapter<FavoriteMovieAdapter.ViewHolder>() {
